...
![PrimeReact](https://img.shields.io/badge/PrimeReact-2196F3?style=flat-square&logo=react&logoColor=white)
...
**[Ranking Jogos](https://github.com/maycon-azevedo/ranking-jogos)**

Daily word game ranking platform for a friend group. Score tracking, leaderboards, streaks, player comparison.

`FastAPI` `React 19` `TypeScript` `PostgreSQL` `Docker`

</td>
<td width="50%">

**[Summarizer Youtube](https://github.com/maycon-azevedo/Summarizer-Youtube)**

YouTube video transcription and summarization tool with async processing.
